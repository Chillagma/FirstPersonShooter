...
void DisplayFunction(void) {
	...
	int start = clock();
			...
			std::cout << random << endl;
				//front face
				glVertex3f(0, 0 , 0+cos(random)*5);
				glVertex3f(0.5, 0, 0+sin(random)*5);

				glVertex3f(0.5, 0.5 , 0 + cos(random) * 5);
				glVertex3f(0, 0.5 , 0 + sin(random) * 5);


				glVertex3f(0, 0.5 , 0 + cos(random) * 5);
				glVertex3f(0, 0 , 0 +sin(random) * 5);
