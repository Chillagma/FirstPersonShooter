...
void DisplayFunction(void) {
	...
	int start = clock();
			...
			//std::cout << random << endl;
				//front face
				float x1 = 0 + cos(random) + (1 - cos(random)) / 4 - 20;
				float y1 = (1 - cos(random)) - sin(random) /4 - 20;
				float x2 = 1 - cos(random) + sin(random) / 4;
				float y2 = (0 + cos(random) + (1 - cos(random)) / 4);
				...
				// East
				glVertex3f((x1+20)/5, (y1+20)/5, 0);
				glVertex3f((x2+20) / 5-3.5 ,(y2+20)/5 -3.5  , 0);
				...
				for (int i = 0; i < 155; i++) {
					...
					//East2
					glVertex3f((x1 + 20) / 5, (y1 + 20) / 5 - 0.25, 0);
					glVertex3f((x2 + 20) / 5- 3.5, (y2 + 20) / 5- 3.5, 0);
