...
void DisplayFunction(void) {
	...
	int start = clock();
			...
			std::cout << random << endl;
				//front face
				glVertex3f(0+cos(random)/2, 0 , 0+sin(random) * 1.5);
				glVertex3f(0.5+ sin(random) / 2, 0, 0-cos(random) * 1.5);

				glVertex3f(0.5 + cos(random) / 2, 0.5 , 0 + sin(random) * 1.5);
				glVertex3f(0 + sin(random) / 2, 0.5 , 0 - cos(random) * 1.5);


				glVertex3f(0 + cos(random) / 2, 0.5 , 0 + sin(random)* 1.5);
				glVertex3f(0 + sin(random) / 2, 0 , 0 - cos(random) * 1.5);

				glVertex3f(0.5 + cos(random) / 2, 0.5 , 0 + sin(random)* 1.5);
				glVertex3f(0.5 + sin(random) / 2, 0 , 0 - cos(random)* 1.5);

				//back face
				glVertex3f(0 + sin(random) / 2, 0.5, 0.5 + cos(random) * 1.5);
				glVertex3f(0.5 + cos(random) / 2, 0.5, 0.5 - sin(random) * 1.5);

				glVertex3f(0 + sin(random) / 2, 0, 0.5 + cos(random) * 1.5);
				glVertex3f(0.5 + cos(random) / 2, 0, 0.5 - sin(random) * 1.5);


				glVertex3f(0 + sin(random) / 2, 0.5, 0.5 + cos(random) * 1.5);
				glVertex3f(0 + cos(random) / 2, 0, 0.5 - sin(random) * 1.5);

				glVertex3f(0.5 + sin(random) / 2, 0.5, 0.5 + cos(random) * 1.5);
				glVertex3f(0.5 + cos(random) / 2, 0, 0.5 - sin(random) * 1.5);
